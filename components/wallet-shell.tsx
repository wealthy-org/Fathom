    ...
    <div className="relative min-h-screen">
      ...
      <header className="border-b border-white/5 bg-black/20 backdrop-blur-xl">
        <div className="mx-auto flex h-20 max-w-5xl items-center justify-between gap-4 px-5 sm:px-6 lg:px-8">
          ...
          <ConnectButton className="shrink-0 rounded-full bg-white px-3 py-2 text-xs font-semibold text-black transition duration-300 hover:scale-105 disabled:cursor-not-allowed disabled:opacity-60 sm:px-4 sm:text-sm" />
        </div>
      </header>
